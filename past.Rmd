...
![Possible Caption](density.png)
**Title:** Density Plot for Cholesterol vs Fat Consumption

**The dataset:** The Nutrition Study Dataset from a cross-sectional study to investigate the relationship between personal characteristics and dietary factors, and plasma concentrations of retinol, beta-carotene and other carotenoids with 315 observations on 17 variables.

**Variables:** Fat, Cholesterol
2
**Description:** The density plot shows the relationship between Fat (g/day) and Cholesterol (g/day). Particularly, it illustrates the density of the points coming bivariate distribution of the two variables. Each colored line represents the percentage of data lie within the region. To the right, there is a legend for us to keep track of the density of each region.
